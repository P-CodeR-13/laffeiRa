 	...
 	<img src="images/greeen.jpg" class="img-fluid" alt="header image">
		<div class="container"> 
			<div class="row">	
				...
				<div class="col-lg-8" align="center"><div class="card"> 
		...
		<div class="row">
			<div class="col-md-6 col-sm-6">
				 ...
				 <div class="footer-logo"><img src="http://hassandesigns.top/html/classified/images/footer-logo.png" alt=""></div>
				  <p style=" text-align: justify;text-justify: inter-word;">Laffera is the leading e-commerce platform in San Juan Philippines. It is a platform tailored for the region, providing both buyers and sellers with an easy, secure and fast online shopping experience through strong payment and logistical support. With a wide selection of product categories ranging from consumer electronics to home & living, health & beauty, baby & toys, fashion and fitness equipment, Shopee aims to continually enhance its platform and become the region’s e-commerce destination of choice.</p>
			</div>
